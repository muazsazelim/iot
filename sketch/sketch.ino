...
enum GameLevel { EASY, INTERMEDIATE };
...
// // --- EASY LEVEL ---
Wall walls_easy[] = {
  {0, 0, 320, 10}, {0, 0, 10, 480}, {0, 470, 320, 10}, {310, 0, 10, 480},
  {10, 80, 230, 10}, {80, 140, 280, 10}, {10, 200, 230, 10},
  {80, 260, 280, 10}, {10, 320, 230, 10}, {80, 380, 280, 10}
};
...
void drawMaze(Adafruit_HX8357* tft) {
  ...
  if (currentLevel == EASY) {
    ...
    gx = goal_x_easy; gy = goal_y_easy; gw = goal_w_easy; gh = goal_h_easy;
  } else {
    currentWalls = walls_intermediate;
    wallCount = numWalls_intermediate;
    gx = goal_x_intermediate; gy = goal_y_intermediate; gw = goal_w_intermediate; gh = goal_h_intermediate;
  }
